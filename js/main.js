...
(function() {
  $(document).ready(function() {
    var baseFileForThisVisit, betAmount, currentEndingLastLineNumber, documentHeight, endingFileForThisVisit, endingFiles, finishTable, firstRoll, handleResults, hasLastEndingSeenBeenIncremented, hideInstructions, howToHandle, incrementLastEndingSeen, instructionsTimeoutID, isWorkerPaused, isWorkerRunningIndefinitely, justKeepPlaying, lastEndingSeen, lastNumWins, lastStorySeen, newTable, newTableIndefinitely, numBaseFiles, numVisitsToSite, oddsOfRollingASix, oddsPayout, pauseWorker, playCrapsAndHandleResults, polyglot, queryString, queryStringValues, rollsPerTable, runningTotal, saveToLocalStorage, sayNextLine, secondRoll, showInstructions, showInstructionsInAMoment, showTotal, startOver, storedObject, storyFileForThisVisit, storyFiles, storyIndex, tellStory, totalWins, updateHeader, updateRunningTotal, whichChapter, wonAtFirstTable, wonFirstOrSecondRoll, worker, _ref, _ref1, _ref2, _ref3, _ref4;
    ...
    if (location.search) {
      ...
      oddsOfRollingASix = (_ref3 = queryStringValues.oddsOfRollingASix) != null ? _ref3 : oddsOfRollingASix;
      startOver = (_ref4 = queryStringValues.startOver) != null ? _ref4 : false;
      if (startOver) {
        numVisitsToSite = 0;
        lastStorySeen = 0;
        lastEndingSeen = 0;
