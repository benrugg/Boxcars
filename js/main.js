...
(function() {
  $(document).ready(function() {
    ...
    tellStory = function() {
      ...
      switch (whichChapter) {
        ...
        default:
          ...
          if (endingPartNumber <= lastEndingNumber) {
    ...
    return $.getJSON("story/" + storyFileForThisVisit + ".json", function(data) {
      ...
      return $.getJSON("story/first-ending.json", function(data) {
        polyglot.extend(data);
